...
public class OrderBoardVo {
	...
	public String toString() {
		return "OrderBoardVo [board_id=" + board_id + ", article_id=" + article_id + ", member_id=" + member_id
	...
	public OrderBoardVo(int board_id, int article_id, String member_id, String article_title, String article_content,
