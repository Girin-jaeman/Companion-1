...
public class HotelVo {
	...
	public HotelVo(int reserve_id, String member_id, int service_id, Date reserve_date, Date reserve_checkin,
			Date reserve_checkout, String reserve_dogtype, int reserve_dogage, String reserve_msg,
			int reserve_state_id) {
		super();
	...
	public String toString() {
		return "HotelVo [reserve_id=" + reserve_id + ", member_id=" + member_id + ", service_id=" + service_id
				+ ", reserve_date=" + reserve_date + ", reserve_checkin=" + reserve_checkin + ", reserve_checkout="
				+ reserve_checkout + ", reserve_dogtype=" + reserve_dogtype + ", reserve_dogage=" + reserve_dogage
				+ ", reserve_msg=" + reserve_msg + ", reserve_state_id=" + reserve_state_id + "]";
	}
