...
public class FAQVo {
	...
	public FAQVo(int no, int board_id, int article_id, String member_id, String article_title, String article_content,
	...
	public String toString() {
		return "FAQVo [no=" + no + ", board_id=" + board_id + ", article_id=" + article_id + ", member_id=" + member_id
