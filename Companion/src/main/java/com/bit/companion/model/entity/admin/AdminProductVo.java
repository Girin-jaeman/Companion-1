...
public class AdminProductVo {
	...
	public AdminProductVo(int category_id, int product_id, String product_name, String product_content,
			int product_price, int product_stock, Date product_date, String product_image, String product_thumb,
			String product_option1, String product_option2, String product_option3, String product_option4,
	...
	public String toString() {
		return "AdminProductVo [category_id=" + category_id + ", product_id=" + product_id + ", product_name="
				+ product_name + ", product_content=" + product_content + ", product_price=" + product_price
				...
				+ product_option4 + ", product_option5=" + product_option5 + "]";
	}
