						...
						<!-- product Detail 페이지로 넘어올 떄 추천 상품 목록을 가지고 넘어와야 함. 해당 상품에 대해서! 로그인 안해도! -->
       					...
       					<div>이 상품을 추천/구매한 사람들이 구입한 상품 </div>
							...
							<c:forEach items="${productRecommendList }" var="bean" >
									<td>
									<a href="#"><img src="http://placehold.it/50x60&text=recmdThumb" 
									width="50" height="60"
									class="img-fluid" alt="Responsive image"  style="display:block;"><p style="text-align:center;">${bean.product_id }</p></a></td>
