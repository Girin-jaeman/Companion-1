				...
				<div class="reserve--right">
					...
					<form class="form-horizontal" method="post">
						...
						<div class="form-group">
							<label for="datepicker" class="col-sm-5 control-label">체크인</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="rsv_checkin" id="datepicker" placeholder="체크인 날짜를 선택하세요.">
							</div>
						</div>
						<div class="form-group">
							<label for="datepicker" class="col-sm-5 control-label">체크아웃</label>
							<div class="col-sm-8">
						...
						<!-- 기타/주의사항 -->
						<div class="form-group">
							<label for="etc" class="col-sm-5 control-label">기타/주의사항</label>
							<div class="col-sm-8">
								<textarea name="rsv_msg" id="etc" cols="60" rows="10" placeholder="기타/주의사항 항목에 대한 내용을 200자 이내로 기재해주세요."></textarea><br/>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-11">
								<button id="btn_submit" type="button" class="btn btn-success btn-lg btn-block">예약상담신청</button>
							</div>
						</div>
					</form>
				</div>
