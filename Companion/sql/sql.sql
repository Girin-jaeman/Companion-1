...
CREATE TABLE IF NOT EXISTS `companion`.`article` (
  ...
  `product_id` VARCHAR(200) NULL DEFAULT NULL COMMENT '상품ID',  
...
CREATE TABLE IF NOT EXISTS `companion`.`cart` (
  ...
  `cart_option` INT(11) NOT NULL DEFAULT '1' COMMENT '장바구니옵션',
...
CREATE TABLE IF NOT EXISTS `companion`.`order_detail` (
  ...
  `order_detail_option` INT(11) NOT NULL DEFAULT '1' COMMENT '주문상세옵션',
