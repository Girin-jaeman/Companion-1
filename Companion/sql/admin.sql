...
select o.order_id,o.order_state_id,o.order_amount,o.member_id,(select m.member_name from member m where o.member_id=m.member_id) as member_name, o.order_name, o.order_phone, o.order_msg, o.order_date from `order` o;